...
// OpenAPI SHA256: 13971e858f0a98e7d9f8919615900c0610af0bd47187671f0f73b9bd7c6dc646
...
enum BackendWire {
  ...
  enum AgentRunInputTask: String, Codable, Equatable, Sendable {
    case `chat` = "chat"
    case `analyzeWorkout` = "analyze_workout"
    case `createPlan` = "create_plan"
    case `modifyPlan` = "modify_plan"
  }

  struct AgentRunInput: Codable, Equatable, Sendable {
    var `schemaVersion`: OnboardingStateSchemaVersion
    var `deviceId`: UUID
    var `threadId`: UUID?
    var `task`: AgentRunInputTask
    var `message`: String
    var `workoutResultId`: UUID?
    var `expectedWorkoutRevision`: SyncCursor?
    init(`schemaVersion`: OnboardingStateSchemaVersion, `deviceId`: UUID, `threadId`: UUID? = nil, `task`: AgentRunInputTask, `message`: String, `workoutResultId`: UUID? = nil, `expectedWorkoutRevision`: SyncCursor? = nil) {
      self.`schemaVersion` = `schemaVersion`
      self.`deviceId` = `deviceId`
      ...
      self.`expectedWorkoutRevision` = `expectedWorkoutRevision`
    }
    private enum CodingKeys: String, CodingKey {
      case `schemaVersion` = "schemaVersion"
      case `deviceId` = "deviceId"
      ...
      case `expectedWorkoutRevision` = "expectedWorkoutRevision"
    }
    init(from decoder: Decoder) throws {
      let c = try decoder.container(keyedBy: CodingKeys.self)
      `schemaVersion` = try c.decode(OnboardingStateSchemaVersion.self, forKey: .`schemaVersion`)
      ...
      `task` = try c.decode(AgentRunInputTask.self, forKey: .`task`)
      `message` = try c.decode(String.self, forKey: .`message`)
      `workoutResultId` = try c.decodeIfPresent(UUID.self, forKey: .`workoutResultId`)
      `expectedWorkoutRevision` = try c.decodeIfPresent(SyncCursor.self, forKey: .`expectedWorkoutRevision`)
    }
    func encode(to encoder: Encoder) throws {
      var c = encoder.container(keyedBy: CodingKeys.self)
      try c.encode(`schemaVersion`, forKey: .`schemaVersion`)
      ...
      try c.encode(`expectedWorkoutRevision`, forKey: .`expectedWorkoutRevision`)
    }
  }
  ...
  struct AgentRun: Codable, Equatable, Sendable {
    ...
    var `lastEventId`: SyncCursor
    var `artifact`: AgentArtifact?
    var `errorCode`: String?
    var `artifactStale`: Bool
    var `createdAt`: BackendInstant
    var `updatedAt`: BackendInstant
    init(`id`: UUID, `threadId`: UUID, `schemaVersion`: OnboardingStateSchemaVersion, `task`: AgentRunInputTask, `status`: AgentRunStatus, `lastEventId`: SyncCursor, `artifact`: AgentArtifact? = nil, `errorCode`: String? = nil, `artifactStale`: Bool, `createdAt`: BackendInstant, `updatedAt`: BackendInstant) {
      self.`id` = `id`
      self.`threadId` = `threadId`
      self.`schemaVersion` = `schemaVersion`
      self.`task` = `task`
      ...
      self.`artifactStale` = `artifactStale`
    ...
    private enum CodingKeys: String, CodingKey {
      ...
      case `artifactStale` = "artifactStale"
    ...
    init(from decoder: Decoder) throws {
      ...
      `schemaVersion` = try c.decode(OnboardingStateSchemaVersion.self, forKey: .`schemaVersion`)
      `task` = try c.decode(AgentRunInputTask.self, forKey: .`task`)
      `status` = try c.decode(AgentRunStatus.self, forKey: .`status`)
      `lastEventId` = try c.decode(SyncCursor.self, forKey: .`lastEventId`)
      `artifact` = try c.decode(AgentArtifact?.self, forKey: .`artifact`)
      `errorCode` = try c.decode(String?.self, forKey: .`errorCode`)
      `artifactStale` = try c.decode(Bool.self, forKey: .`artifactStale`)
    ...
    func encode(to encoder: Encoder) throws {
      ...
      try c.encode(`artifactStale`, forKey: .`artifactStale`)
      try c.encode(`createdAt`, forKey: .`createdAt`)
      try c.encode(`updatedAt`, forKey: .`updatedAt`)
    }
  }

  enum AgentCapabilitiesTransport: String, Codable, Equatable, Sendable {
    case `sse` = "sse"
  }

  enum AgentCapabilitiesMemory: String, Codable, Equatable, Sendable {
    case `manual` = "manual"
  }

  enum AgentCapabilitiesEventRetentionDays: Int, Codable, Equatable, Sendable {
    case value7 = 7
  }
  ...
  struct AgentCapabilities: Codable, Equatable, Sendable {
    ...
    var `enabled`: Bool
    var `configured`: Bool
    var `tasks`: AgentCapabilitiesTasks
    var `transport`: AgentCapabilitiesTransport
    var `memory`: AgentCapabilitiesMemory
    var `requiresConsent`: BackendTrue
    var `requiredEntitlement`: String
    var `maxGenerativeCalls`: Int
    var `eventRetentionDays`: AgentCapabilitiesEventRetentionDays
    init(`schemaVersion`: OnboardingStateSchemaVersion, `enabled`: Bool, `configured`: Bool, `tasks`: AgentCapabilitiesTasks, `transport`: AgentCapabilitiesTransport, `memory`: AgentCapabilitiesMemory, `requiresConsent`: BackendTrue, `requiredEntitlement`: String, `maxGenerativeCalls`: Int, `eventRetentionDays`: AgentCapabilitiesEventRetentionDays) {
      self.`schemaVersion` = `schemaVersion`
      ...
      self.`maxGenerativeCalls` = `maxGenerativeCalls`
    ...
    private enum CodingKeys: String, CodingKey {
      ...
      case `requiredEntitlement` = "requiredEntitlement"
      case `maxGenerativeCalls` = "maxGenerativeCalls"
      case `eventRetentionDays` = "eventRetentionDays"
    }
    init(from decoder: Decoder) throws {
      let c = try decoder.container(keyedBy: CodingKeys.self)
      `schemaVersion` = try c.decode(OnboardingStateSchemaVersion.self, forKey: .`schemaVersion`)
      ...
      `tasks` = try c.decode(AgentCapabilitiesTasks.self, forKey: .`tasks`)
      `transport` = try c.decode(AgentCapabilitiesTransport.self, forKey: .`transport`)
      `memory` = try c.decode(AgentCapabilitiesMemory.self, forKey: .`memory`)
      `requiresConsent` = try c.decode(BackendTrue.self, forKey: .`requiresConsent`)
      `requiredEntitlement` = try c.decode(String.self, forKey: .`requiredEntitlement`)
      `maxGenerativeCalls` = try c.decode(Int.self, forKey: .`maxGenerativeCalls`)
      `eventRetentionDays` = try c.decode(AgentCapabilitiesEventRetentionDays.self, forKey: .`eventRetentionDays`)
    }
    func encode(to encoder: Encoder) throws {
      var c = encoder.container(keyedBy: CodingKeys.self)
      try c.encode(`schemaVersion`, forKey: .`schemaVersion`)
      ...
      try c.encode(`requiresConsent`, forKey: .`requiresConsent`)
      try c.encode(`requiredEntitlement`, forKey: .`requiredEntitlement`)
      try c.encode(`maxGenerativeCalls`, forKey: .`maxGenerativeCalls`)
      try c.encode(`eventRetentionDays`, forKey: .`eventRetentionDays`)
    }
  }

  enum AgentMemoryInputCategory: String, Codable, Equatable, Sendable {
    case `trainingPreference` = "training_preference"
    case `communication` = "communication"
    case `temporaryConstraint` = "temporary_constraint"
  }

  struct AgentMemoryInput: Codable, Equatable, Sendable {
    var `expectedRevision`: SyncCursor?
    var `category`: AgentMemoryInputCategory
    var `content`: String
    var `expiresAt`: BackendInstant?
    init(`expectedRevision`: SyncCursor? = nil, `category`: AgentMemoryInputCategory, `content`: String, `expiresAt`: BackendInstant? = nil) {
    ...
    init(from decoder: Decoder) throws {
      let c = try decoder.container(keyedBy: CodingKeys.self)
      `expectedRevision` = try c.decode(SyncCursor?.self, forKey: .`expectedRevision`)
      `category` = try c.decode(AgentMemoryInputCategory.self, forKey: .`category`)
  ...
  enum AgentMemorySource: String, Codable, Equatable, Sendable {
    case `athlete` = "athlete"
  }

  struct AgentMemory: Codable, Equatable, Sendable {
    var `category`: AgentMemoryInputCategory
    var `content`: String
    var `expiresAt`: BackendInstant?
    var `id`: UUID
    var `revision`: SyncCursor
    var `source`: AgentMemorySource
    var `createdAt`: BackendInstant
    var `updatedAt`: BackendInstant
    init(`category`: AgentMemoryInputCategory, `content`: String, `expiresAt`: BackendInstant? = nil, `id`: UUID, `revision`: SyncCursor, `source`: AgentMemorySource, `createdAt`: BackendInstant, `updatedAt`: BackendInstant) {
      self.`category` = `category`
      self.`content` = `content`
      self.`expiresAt` = `expiresAt`
      self.`id` = `id`
    ...
    init(from decoder: Decoder) throws {
      ...
      `source` = try c.decode(AgentMemorySource.self, forKey: .`source`)
      `createdAt` = try c.decode(BackendInstant.self, forKey: .`createdAt`)
      `updatedAt` = try c.decode(BackendInstant.self, forKey: .`updatedAt`)
    }
    func encode(to encoder: Encoder) throws {
  ...
  enum AgentArtifactKind: String, Codable, Equatable, Sendable {
    case `answer` = "answer"
    case `workoutAnalysis` = "workout_analysis"
    case `scopeRedirect` = "scope_redirect"
    case `clarification` = "clarification"
  }

  struct AgentArtifact: Codable, Equatable, Sendable {
    var `content`: String
    var `observations`: [AgentArtifactObservationsItem]
    var `interpretations`: [AgentArtifactInterpretationsItem]
    var `limitations`: [String]
    var `recommendations`: [String]
    var `schemaVersion`: OnboardingStateSchemaVersion
    var `kind`: AgentArtifactKind
    var `citations`: [AgentCitation]
    var `analyzedResult`: AgentArtifactAnalyzedResult?
    init(`content`: String, `observations`: [AgentArtifactObservationsItem], `interpretations`: [AgentArtifactInterpretationsItem], `limitations`: [String], `recommendations`: [String], `schemaVersion`: OnboardingStateSchemaVersion, `kind`: AgentArtifactKind, `citations`: [AgentCitation], `analyzedResult`: AgentArtifactAnalyzedResult? = nil) {
      self.`content` = `content`
    ...
    private enum CodingKeys: String, CodingKey {
      ...
      case `analyzedResult` = "analyzedResult"
    }
    init(from decoder: Decoder) throws {
      let c = try decoder.container(keyedBy: CodingKeys.self)
      `content` = try c.decode(String.self, forKey: .`content`)
      `observations` = try c.decode([AgentArtifactObservationsItem].self, forKey: .`observations`)
      `interpretations` = try c.decode([AgentArtifactInterpretationsItem].self, forKey: .`interpretations`)
      `limitations` = try c.decode([String].self, forKey: .`limitations`)
      `recommendations` = try c.decode([String].self, forKey: .`recommendations`)
      `schemaVersion` = try c.decode(OnboardingStateSchemaVersion.self, forKey: .`schemaVersion`)
      `kind` = try c.decode(AgentArtifactKind.self, forKey: .`kind`)
      `citations` = try c.decode([AgentCitation].self, forKey: .`citations`)
      `analyzedResult` = try c.decode(AgentArtifactAnalyzedResult?.self, forKey: .`analyzedResult`)
    }
    func encode(to encoder: Encoder) throws {
      var c = encoder.container(keyedBy: CodingKeys.self)
      try c.encode(`content`, forKey: .`content`)
      try c.encode(`observations`, forKey: .`observations`)
      try c.encode(`interpretations`, forKey: .`interpretations`)
      ...
      try c.encode(`analyzedResult`, forKey: .`analyzedResult`)
    }
  }
  ...
  struct AgentCapabilitiesTasks: Codable, Equatable, Sendable {
    var `chat`: Bool
    var `analyzeWorkout`: Bool
    var `createPlan`: BackendFalse
    var `modifyPlan`: BackendFalse
    init(`chat`: Bool, `analyzeWorkout`: Bool, `createPlan`: BackendFalse, `modifyPlan`: BackendFalse) {
      self.`chat` = `chat`
      self.`analyzeWorkout` = `analyzeWorkout`
    ...
    init(from decoder: Decoder) throws {
      let c = try decoder.container(keyedBy: CodingKeys.self)
      `chat` = try c.decode(Bool.self, forKey: .`chat`)
      `analyzeWorkout` = try c.decode(Bool.self, forKey: .`analyzeWorkout`)
      `createPlan` = try c.decode(BackendFalse.self, forKey: .`createPlan`)
      `modifyPlan` = try c.decode(BackendFalse.self, forKey: .`modifyPlan`)
    }
    func encode(to encoder: Encoder) throws {
      var c = encoder.container(keyedBy: CodingKeys.self)
      try c.encode(`chat`, forKey: .`chat`)
      try c.encode(`analyzeWorkout`, forKey: .`analyzeWorkout`)
      try c.encode(`createPlan`, forKey: .`createPlan`)
      try c.encode(`modifyPlan`, forKey: .`modifyPlan`)
    }
  }

  struct AgentArtifactObservationsItem: Codable, Equatable, Sendable {
    var `text`: String
    var `metricRefs`: [String]
    init(`text`: String, `metricRefs`: [String]) {
      self.`text` = `text`
      self.`metricRefs` = `metricRefs`
    }
    private enum CodingKeys: String, CodingKey {
      case `text` = "text"
      case `metricRefs` = "metricRefs"
    }
    init(from decoder: Decoder) throws {
      let c = try decoder.container(keyedBy: CodingKeys.self)
      `text` = try c.decode(String.self, forKey: .`text`)
      `metricRefs` = try c.decode([String].self, forKey: .`metricRefs`)
    }
    func encode(to encoder: Encoder) throws {
      var c = encoder.container(keyedBy: CodingKeys.self)
      try c.encode(`text`, forKey: .`text`)
      try c.encode(`metricRefs`, forKey: .`metricRefs`)
    }
  }

  struct AgentArtifactInterpretationsItem: Codable, Equatable, Sendable {
    var `text`: String
  ...
  struct AgentCitation: Codable, Equatable, Sendable {
    var `id`: String
    var `version`: OnboardingStateSchemaVersion
    var `title`: String
    var `url`: String
    var `claim`: String
    var `limitations`: String
    init(`id`: String, `version`: OnboardingStateSchemaVersion, `title`: String, `url`: String, `claim`: String, `limitations`: String) {
      self.`id` = `id`
      self.`version` = `version`
      self.`title` = `title`
      self.`url` = `url`
    ...
    init(from decoder: Decoder) throws {
      ...
      `version` = try c.decode(OnboardingStateSchemaVersion.self, forKey: .`version`)
      `title` = try c.decode(String.self, forKey: .`title`)
  ...
  struct AgentArtifactAnalyzedResult: Codable, Equatable, Sendable {
    var `id`: UUID
    var `revision`: SyncCursor
    init(`id`: UUID, `revision`: SyncCursor) {
      self.`id` = `id`
      self.`revision` = `revision`
    }
    private enum CodingKeys: String, CodingKey {
  ...
  struct SyncChangeAthlete: Codable, Equatable, Sendable {
    ...
    var `revision`: BackendRevision?
    var `entityType`: AgentMemorySource
    var `payload`: AthleteRecord?
    init(`sequence`: BackendRevision, `entityId`: UUID, `operation`: SyncChangeAthleteOperation, `revision`: BackendRevision? = nil, `entityType`: AgentMemorySource, `payload`: AthleteRecord? = nil) {
      self.`sequence` = `sequence`
    ...
    init(from decoder: Decoder) throws {
      ...
      `revision` = try c.decode(BackendRevision?.self, forKey: .`revision`)
      `entityType` = try c.decode(AgentMemorySource.self, forKey: .`entityType`)
