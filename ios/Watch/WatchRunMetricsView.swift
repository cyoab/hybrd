...
struct WatchRunMetricsView: View {
  ...
  var pace: Double?
  var gps: String
  @ScaledMetric(relativeTo: .title) private var paceSize = 34
  @ScaledMetric(relativeTo: .title2) private var metricSize = 29
  @ScaledMetric(relativeTo: .title2) private var heartSize = 25
