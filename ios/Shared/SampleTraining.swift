  ...
  static func makePlan(profile: TrainingProfile, start: Date = Date()) -> TrainingPlan {
    ...
    for week in 0..<4 {
      ...
      workouts.append(TrainingWorkout(
        ...
        effort: "RPE 7", isKey: true,
        segments: [
          RunSegment(title: "Warm-up", seconds: 900, cue: "Start with easy, conversational running.", phase: .warmUp, target: "easy"),
          RunSegment(title: "Work", seconds: 480, cue: "A controlled, comfortably hard effort. This pace is illustrative sample data.", phase: .work, repetitions: repetitions, target: "@ 4:22–4:30"),
          RunSegment(title: "Recovery", seconds: 180, cue: "Jog easily after each work interval.", phase: .recovery, repetitions: repetitions, target: "jog"),
          RunSegment(title: "Cool-down", seconds: 600, cue: "Let your breathing settle as you ease the pace.", phase: .coolDown, target: "easy")
      ...
      for (offset, title, distance) in [(1, "Easy run", 6_500), (4, "Aerobic base", 8_100), (5, "Long easy run", 14_000)] {
        ...
        workouts.append(TrainingWorkout(
          ...
          minutes: minutes, distanceMeters: meters, effort: "RPE 3–4", isKey: offset == 5,
          segments: [
            RunSegment(title: "Warm-up", seconds: 300, cue: "Ease into the run.", phase: .warmUp, target: "easy"),
            RunSegment(title: "Easy running", seconds: (minutes - 10) * 60, cue: "You should be able to speak in full sentences.", phase: .easy, target: "easy"),
            RunSegment(title: "Cool-down", seconds: 300, cue: "Gradually slow down.", phase: .coolDown, target: "easy")
