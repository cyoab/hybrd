...
8. Run native Apple login and sandbox purchase/renewal/restore/refund, AI-response quality, real-device push and full device-restore acceptance tests before launch.
